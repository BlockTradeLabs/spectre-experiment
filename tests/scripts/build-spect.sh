...
../target/release/tanssi-node build-spec --chain dancebox-local --parachain-id 1000 --add-container-chain specs/spectre-node.json --invulnerable "Collator1000-01"  --invulnerable "Collator2001-01" > specs/tanssi-1000.json
